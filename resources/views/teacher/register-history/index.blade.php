            ...
            <table class="table table-bordered" id="" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($item->danhsach_tinhtrang == 0 )
                            <a href="{{route('teacher.computer-register.destroy',$item->id)}}" class="btn btn-primary" title="Xóa" onclick="return confirm('Bạn có muốn hủy yêu cầu này không?')">
                                Hủy yêu cầu
                            </a>
                            ...
                            @else
                            <a href="{{route('teacher.computer-register.register-result', $item->id)}}" class="btn btn-success " title="Xem">
                                Xem chi tiết
                            </a>
                            @endif
                        </td>
